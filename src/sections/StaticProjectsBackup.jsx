...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        'Podcastr is a revolutionary AI-powered podcast platform that enables users to create, discover, and enjoy podcasts with cutting-edge technology. Built with Next.js 14 and advanced AI integration for an immersive audio experience.',
  ...
  return (
    <section className="c-space my-20" id="projects">
      ...
      <div className="max-w-4xl mx-auto">
        <div className={`relative group bg-gradient-to-br ${currentProjectData.gradient} backdrop-blur-xl rounded-3xl p-8 md:p-12 border border-white/10 transition-all duration-700 hover:border-white/30 hover:${currentProjectData.glowColor} hover:shadow-2xl`}>
          ...
          <div className="absolute top-6 right-6 w-12 h-12 bg-white/10 backdrop-blur-md rounded-full flex items-center justify-center border border-white/20 group-hover:bg-white/20 transition-all duration-300">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap gap-3">
                {currentProjectData.techStack.map((tech, index) => (
                  <div
                    key={index}
                    className="group/tech flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-md rounded-full border border-white/20 hover:bg-white/20 hover:border-white/40 hover:shadow-lg transition-all duration-300 cursor-pointer"
                  >
                    <img src={tech.icon} alt={tech.name} className="w-5 h-5 group-hover/tech:scale-110 transition-transform duration-300" />
            ...
            <div className="flex gap-4 pt-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group/btn flex items-center gap-3 px-6 py-3 bg-white/10 backdrop-blur-md hover:bg-white/20 rounded-full text-white font-semibold border border-white/20 hover:border-white/40 transition-all duration-300 hover:shadow-xl hover:shadow-white/20 hover:scale-105"
              >
                <svg className="w-5 h-5 group-hover/btn:rotate-12 transition-transform duration-300" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div className="flex items-center justify-center gap-8 mt-12">
          ...
          <button
            onClick={handlePrev}
            className="group flex items-center justify-center w-12 h-12 bg-white/10 backdrop-blur-md rounded-full border border-white/20 hover:bg-white/20 hover:border-white/40 hover:shadow-lg hover:shadow-white/20 transition-all duration-300 hover:scale-110"
