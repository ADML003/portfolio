...
const AnimatedName = ({ name, delay = 0 }) => {
  ...
  return (
    <div className="hero-name" aria-label={name}>
      {words.map((word, wi) => (
        <span key={wi} style={{ display: 'inline-block', overflow: 'hidden', marginRight: wi < words.length - 1 ? '0.25em' : 0 }}>
...
const Hero = () => {
  ...
  const t = (n) => ({ duration: 0.75, ease: EASE_OUT_EXPO, delay: n });
      ...
      <div className="container">
        <div className="hero-inner">
          ...
          <div className="hero-content">
            ...
            {/* Name */}
            <AnimatedName name="Aditya Malhotra" delay={0.1} />
            ...
            <motion.p
              ...
              transition={t(0.62)}
            >
              I build full-stack web applications and AI-powered products that solve real
              problems — from intelligent SaaS platforms to data dashboards. Focused on
